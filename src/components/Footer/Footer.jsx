  ...
  return (
    <footer className=" w-100vw relative bottom-0 bg-[rgb(11,20,47)] bg-opacity-85 backdrop-filter backdrop-blur-lg h-1/4  ">
      <div className="py-20 px-2 w-5/6 m-auto text-[rgb(117,117,117)] flex justify-between  gap-5 flex-col xl:flex-row">
        ...
        <div className=" flex  xl:justify-between w-3/5 ml-0  md:ml-0 lg:mr-auto xl:ml-auto xl:mr-0 flex-col  md:flex-row ">
          <div className="mb-8 lg:mb-0">
            ...
            <div className="flex flex-wrap justify-between mt-12 w-80 flex-col min-[500px]:flex-row min-[500px]:w-[28rem]">
              <a
                href="/#"
                className=" cursor-pointer w-1/2 py-3 text-base medium:text-base  hover:text-white leading-[21px] medium:leading-6 font-semibold text-gray-300"
              >
                About us
              </a>
              <a
